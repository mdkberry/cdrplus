<?php
	function multi_attach_mail($to, $data, $sendermail)
	{
	    ...
	    $subject = "CDR Plus schedule generated call report";
	    $message = "Attached is an automated schedule generated call report. To cancel it please contact cdr@mbitservices.com.au";
	    $headers = "From: $from";
